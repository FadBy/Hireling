...
player = Player()
hubroom = Room(player, TEXTURES_DEFAULT, width // 2 - 8 * METR, height // 2 - 5 * METR, 14, 7, [["up", 7], ["left", 2]])
transhub = Room(player, TEXTURES_DEFAULT, width // 2 - 3 * METR, height // 2 - 26.5 * METR, 4, 20,
                [["down", 2], ["up", 2]])
